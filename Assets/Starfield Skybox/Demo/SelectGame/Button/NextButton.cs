        ...
        if (game1.transform.position.x <= 680.5 && game1.transform.position.x >= 376.5)
         {
            ...
            game2.transform.position = new Vector3(game1.transform.position.x, game1.transform.position.y, 0);
            game3.transform.position = new Vector3(game1.transform.position.x +700, game1.transform.position.y, 0);
           ...
           else if (game2.transform.position.x <= 680.5 && game2.transform.position.x >= 376.5)
           {
               ...
               game3.transform.position = new Vector3(game2.transform.position.x, game1.transform.position.y, 0);
               game1.transform.position = new Vector3(game2.transform.position.x+700, game1.transform.position.y, 0);
           ...
           else if (game3.transform.position.x <= 680.5 && game3.transform.position.x >= 376.5)
           {
               ...
               game1.transform.position = new Vector3(game3.transform.position.x, game1.transform.position.y, 0);
               game2.transform.position = new Vector3(game3.transform.position.x+700, game1.transform.position.y, 0);
